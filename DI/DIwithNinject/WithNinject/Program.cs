...
//            kernel = new StandardKernel(new BasicLoggingModule());
//
...
//            namedEngine.RunProcess();
            ...
            kernel = new StandardKernel(new PropertyInjectionModule());

            var legacyEngine = kernel.Get<LegacyEngine>();
            legacyEngine.RunProcess();
